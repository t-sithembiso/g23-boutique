...
public class ItemTypeFactory {
    ...
    public static ItemType buildItemType( int itemTypeId,String itemName,String category,int cost, String supplierName){
        ...
        return new ItemType.Builder().setItemTypeId(itemTypeId)
